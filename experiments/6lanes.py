...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='/home/longshui/ql-signal/nets/6lanes/single-intersection.rou.xml', help="Route definition xml file.\n")
    prs.add_argument("-a", dest="alpha", type=float, default=0.05, required=False, help="Alpha learning rate.\n")
    prs.add_argument("-g", dest="gamma", type=float, default=0.9, required=False, help="Gamma discount rate.\n")
    prs.add_argument("-e", dest="epsilon", type=float, default=0.1, required=False, help="Epsilon.\n")
    ...
    out_csv = '../outputs/6lanes/ql_heavy'
